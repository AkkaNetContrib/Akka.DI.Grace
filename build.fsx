...
let authors = [ "Akka.NET Team / Kostas Stroggylos" ]
let copyright = "Copyright © 2017 Akka.NET Team / Kostas Stroggylos"
...
Target "RunTests" <| fun _ ->  
    let xunitTestAssemblies = !! "src/**/bin/Release/Akka.DI.Grace.Tests.dll"
